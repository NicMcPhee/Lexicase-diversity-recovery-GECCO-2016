...
div15run0$run <- "Population A"
div15run1$run <- "Population B"
div90run6$run <- "Population C"
div90run10$run <- "Population D"
drop25run0$run <- "Population E"
drop25run8$run <- "Population F"

dl_div15run0$run <- "Population G"
dl_div15run1$run <- "Population H"
dl_div90run0$run <- "Population I"
dl_div90run3$run <- "Population J"

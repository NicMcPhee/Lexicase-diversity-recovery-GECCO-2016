...
In this subsection we use stored populations that occured in runs using lexicase selection and achieved error diversity greater than 0.9. As such, the initial populations of the runs have very high diversity, with most individuals producing distinct error vectors.
...
Figure~\ref{fig:RSWNhighDiversity} plots continued runs started from two populations (C and D) stored from GP evolving on the RSWN problem. 

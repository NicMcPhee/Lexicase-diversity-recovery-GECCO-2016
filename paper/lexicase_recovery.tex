...
In this subsection we present sets of runs starting with populations that occured in runs using lexicase selection and achieved error diversity greater than 0.9. 
